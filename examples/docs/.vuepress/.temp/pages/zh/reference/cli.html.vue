<template><div><h1 id="命令行接口" tabindex="-1"><a class="header-anchor" href="#命令行接口" aria-hidden="true">#</a> 命令行接口</h1>
<NpmBadge package="@vuepress/cli" />
<p>VuePress 命令行接口是由 <a href="https://www.npmjs.com/package/@vuepress/cli" target="_blank" rel="noopener noreferrer">@vuepress/cli<ExternalLinkIcon/></a> 包提供的。它包含在 <a href="https://www.npmjs.com/package/vuepress" target="_blank" rel="noopener noreferrer">vuepress<ExternalLinkIcon/></a> 包之中，当然你也可以单独安装它。</p>
<p>执行 <code v-pre>vuepress --help</code> 来获取下列帮助信息：</p>
...
<p>VuePress 使用了 <a href="https://www.npmjs.com/package/debug" target="_blank" rel="noopener noreferrer">debug<ExternalLinkIcon/></a> 模块。</p>
<p>设置环境变量 <code v-pre>DEBUG=vuepress*</code> 可以启用调试日志。</p>
</div>
<h2 id="dev" tabindex="-1"><a class="header-anchor" href="#dev" aria-hidden="true">#</a> dev</h2>
...
<h2 id="info" tabindex="-1"><a class="header-anchor" href="#info" aria-hidden="true">#</a> info</h2>
<p>输出当前系统和依赖相关的信息。</p>
