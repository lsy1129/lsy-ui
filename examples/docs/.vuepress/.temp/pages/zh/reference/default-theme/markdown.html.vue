...
[content]
:::
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>type</code> 是必需的， <code v-pre>title</code> 和 <code v-pre>content</code> 是可选的。</p>
<p>支持的 <code v-pre>type</code> 有：</p>
<ul>
...
<ul>
<li><code v-pre>code-group</code></li>
<li><code v-pre>code-group-item</code></li>
</ul>
</li>
</ul>
</li>
