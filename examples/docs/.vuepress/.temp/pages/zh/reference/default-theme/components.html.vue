...
<h2 id="badge" tabindex="-1"><a class="header-anchor" href="#badge" aria-hidden="true">#</a> Badge <Badge text="badge" /></h2>
<ul>
<li>
<p>Props:</p>
<ul>
<li>type
<ul>
<li>类型： <code v-pre>'tip' | 'warning' | 'danger'</code></li>
<li>默认值： <code v-pre>'tip'</code></li>
</ul>
</li>
<li>text
<ul>
...
<li>vertical
<ul>
<li>类型： <code v-pre>'top' | 'middle' | 'bottom' | undefined</code></li>
...
<h2 id="codegroup" tabindex="-1"><a class="header-anchor" href="#codegroup" aria-hidden="true">#</a> CodeGroup</h2>
<ul>
<li>
<p>详情：</p>
...
<h2 id="codegroupitem" tabindex="-1"><a class="header-anchor" href="#codegroupitem" aria-hidden="true">#</a> CodeGroupItem</h2>
<ul>
<li>
<p>Props:</p>
<ul>
...
<ul>
<li>类型： <code v-pre>string</code></li>
<li>是否必需： <code v-pre>true</code></li>
</ul>
</li>
<li>active
<ul>
...
<p>可以通过 <code v-pre>active</code> Prop 来设置初始激活的元素。如果不设置，默认激活第一个元素。</p>
</li>
<li>
<p>示例：</p>
</li>
...
<p>你必须在 <code v-pre>&lt;CodeGroupItem&gt;</code> 的开始标签和代码块之间添加一个空行，否则代码块无法被 Markdown 正确解析。</p>
<p>所有内容首先都必须是合法的 Markdown ，然后才是一个 Vue SFC 。</p>
<p>了解更多： <RouterLink to="/zh/advanced/cookbook/markdown-and-vue-sfc.html">Cookbook &gt; Markdown 与 Vue SFC</RouterLink></p>
