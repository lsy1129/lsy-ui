...
<h2 id="所有页面" tabindex="-1"><a class="header-anchor" href="#所有页面" aria-hidden="true">#</a> 所有页面</h2>
<p>本章节中的 Frontmatter 会在所有类型的页面中生效。</p>
<h3 id="externallinkicon" tabindex="-1"><a class="header-anchor" href="#externallinkicon" aria-hidden="true">#</a> externalLinkIcon</h3>
<ul>
<li>
...
<li>
<p>详情：</p>
<p>由<RouterLink to="/zh/reference/plugin/external-link-icon.html#externallinkicon">@vuepress/plugin-external-link-icon</RouterLink> 提供。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/reference/default-theme/config.html#themeplugins-externallinkicon">默认主题 &gt; 配置 &gt; themePlugins.externalLinkIcon</RouterLink></li>
</ul>
</li>
</ul>
...
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/reference/default-theme/config.html#navbar">默认主题 &gt; 配置 &gt; navbar</RouterLink></li>
</ul>
</li>
</ul>
<h3 id="pageclass" tabindex="-1"><a class="header-anchor" href="#pageclass" aria-hidden="true">#</a> pageClass</h3>
<ul>
<li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后你可以在 <code v-pre>.vuepress/styles/index.scss</code> 文件中为这个页面添加自定义样式：</p>
<div class="language-scss ext-scss line-numbers-mode"><pre v-pre class="language-scss"><code><span class="token selector">.theme-container.custom-page-class </span><span class="token punctuation">{</span>
  <span class="token comment">/* 页面样式 */</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>参考：
<ul>
<li><RouterLink to="/zh/reference/default-theme/styles.html#style-%E6%96%87%E4%BB%B6">默认主题 &gt; 样式 &gt; Style 文件</RouterLink></li>
</ul>
</li>
</ul>
<h2 id="首页" tabindex="-1"><a class="header-anchor" href="#首页" aria-hidden="true">#</a> 首页</h2>
...
<p>详情：</p>
<p>设定该页面是首页还是普通页面。</p>
<p>如果你不设置该 Frontmatter 或将其设为 <code v-pre>false</code> ，则该页面会是一个 <a href="#%E6%99%AE%E9%80%9A%E9%A1%B5%E9%9D%A2">普通页面</a></p>
</li>
<li>
<p>示例：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code><span class="token front-matter-block"><span class="token punctuation">---</span>
...
<h3 id="heroimage" tabindex="-1"><a class="header-anchor" href="#heroimage" aria-hidden="true">#</a> heroImage</h3>
<ul>
<li>
<p>类型： <code v-pre>string</code></p>
</li>
...
<p>示例：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code><span class="token front-matter-block"><span class="token punctuation">---</span>
<span class="token front-matter yaml language-yaml"><span class="token comment"># Public 文件路径</span>
...
<h3 id="heroimagedark" tabindex="-1"><a class="header-anchor" href="#heroimagedark" aria-hidden="true">#</a> heroImageDark</h3>
<ul>
<li>
<p>类型： <code v-pre>string</code></p>
</li>
<li>
<p>详情：</p>
<p>在夜间模式中使用的首页图片的 URL 。</p>
<p>如果你想在夜间模式中使用不同的首页图片，就可以使用该配置项。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><a href="#heroimage">默认主题 &gt; Frontmatter &gt; heroImage</a></li>
<li><RouterLink to="/zh/reference/default-theme/config.html#colormode">默认主题 &gt; 配置 &gt; colorMode</RouterLink></li>
</ul>
</li>
</ul>
<h3 id="heroalt" tabindex="-1"><a class="header-anchor" href="#heroalt" aria-hidden="true">#</a> heroAlt</h3>
<ul>
<li>
<p>类型： <code v-pre>string</code></p>
</li>
<li>
<p>详情：</p>
<p>首页图片的 <code v-pre>alt</code> 属性。</p>
<p>如果不设置，则默认使用 <a href="#heroText">heroText</a> 。</p>
</li>
</ul>
<h3 id="herotext" tabindex="-1"><a class="header-anchor" href="#herotext" aria-hidden="true">#</a> heroText</h3>
<ul>
<li>
...
<p>设置为 <code v-pre>null</code> 来禁用首页大标题。</p>
</li>
</ul>
<h3 id="tagline" tabindex="-1"><a class="header-anchor" href="#tagline" aria-hidden="true">#</a> tagline</h3>
<ul>
<li>
<p>类型： <code v-pre>string | null</code></p>
</li>
...
<p>设置为 <code v-pre>null</code> 来禁用首页标语。</p>
</li>
</ul>
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code><span class="token builtin">Array</span><span class="token operator">&lt;</span><span class="token punctuation">{</span>
  ...
  type<span class="token operator">?</span><span class="token operator">:</span> <span class="token string">'primary'</span> <span class="token operator">|</span> <span class="token string">'secondary'</span>
...
<span class="token punctuation">---</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="features" tabindex="-1"><a class="header-anchor" href="#features" aria-hidden="true">#</a> features</h3>
<ul>
<li>类型：</li>
</ul>
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code><span class="token builtin">Array</span><span class="token operator">&lt;</span><span class="token punctuation">{</span>
...
<span class="token punctuation">---</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="footer" tabindex="-1"><a class="header-anchor" href="#footer" aria-hidden="true">#</a> footer</h3>
<ul>
<li>
<p>类型： <code v-pre>string</code></p>
</li>
...
<h3 id="footerhtml" tabindex="-1"><a class="header-anchor" href="#footerhtml" aria-hidden="true">#</a> footerHtml</h3>
<ul>
<li>
<p>类型： <code v-pre>boolean</code></p>
</li>
...
<p>详情：</p>
<p>是否允许页脚中使用 HTML 。</p>
<p>如果设置为 <code v-pre>true</code> ，那么 <a href="#footer">footer</a> 会被作为 HTML 代码处理。</p>
</li>
</ul>
<h2 id="普通页面" tabindex="-1"><a class="header-anchor" href="#普通页面" aria-hidden="true">#</a> 普通页面</h2>
...
<li>
<p>详情：</p>
<p>本页面中 <em>编辑此页</em> 链接的 Pattern 。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/reference/default-theme/config.html#editlinkpattern">默认主题 &gt; 配置 &gt; editLinkPattern</RouterLink></li>
</ul>
</li>
</ul>
...
<h3 id="sidebardepth" tabindex="-1"><a class="header-anchor" href="#sidebardepth" aria-hidden="true">#</a> sidebarDepth</h3>
<ul>
<li>
...
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/reference/default-theme/config.html#sidebardepth">默认主题 &gt; 配置 &gt; sidebarDepth</RouterLink></li>
</ul>
</li>
</ul>
<h3 id="prev" tabindex="-1"><a class="header-anchor" href="#prev" aria-hidden="true">#</a> prev</h3>
<ul>
<li>
<p>类型： <code v-pre>NavLink | string</code></p>
</li>
<li>
<p>详情：</p>
<p>上一个页面的链接。</p>
<p>如果你不设置该 Frontmatter ，该链接会自动根据侧边栏配置进行推断。</p>
<p>为了手动配置上一页面的链接，你可以将其设置为一个 <code v-pre>NavLink</code> 对象或者一个字符串：</p>
<ul>
<li><code v-pre>NavLink</code> 对象应该有一个 <code v-pre>text</code> 字段和一个 <code v-pre>link</code> 字段。</li>
<li>字符串应为目标页面文件的路径。它将会被转换为 <code v-pre>NavLink</code> 对象，将页面标题作为 <code v-pre>text</code> ，将页面路由路径作为 <code v-pre>link</code> 。</li>
</ul>
</li>
<li>
<p>示例：</p>
...
<span class="token punctuation">---</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="next" tabindex="-1"><a class="header-anchor" href="#next" aria-hidden="true">#</a> next</h3>
<ul>
<li>
<p>类型： <code v-pre>NavLink | string</code></p>
</li>
