<template><div><h1 id="node-api" tabindex="-1"><a class="header-anchor" href="#node-api" aria-hidden="true">#</a> Node API</h1>
<NpmBadge package="@vuepress/core" />
<p>Node API 是由 <a href="https://www.npmjs.com/package/@vuepress/core" target="_blank" rel="noopener noreferrer">@vuepress/core<ExternalLinkIcon/></a> 包提供的。它是 <a href="https://www.npmjs.com/package/vuepress" target="_blank" rel="noopener noreferrer">vuepress<ExternalLinkIcon/></a> 包的依赖之一，当然你也可以单独安装它：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="app" tabindex="-1"><a class="header-anchor" href="#app" aria-hidden="true">#</a> App</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="writetemp" tabindex="-1"><a class="header-anchor" href="#writetemp" aria-hidden="true">#</a> writeTemp</h3>
<ul>
<li>函数签名：</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="init" tabindex="-1"><a class="header-anchor" href="#init" aria-hidden="true">#</a> init</h3>
<ul>
<li>函数签名：</li>
</ul>
...
<p>详情：</p>
<p>该 Page 的标识。</p>
<p>Page Key 会被用作页面路由的 <a href="https://router.vuejs.org/api/#name-2" target="_blank" rel="noopener noreferrer">name<ExternalLinkIcon/></a>。</p>
</li>
<li>
<p>参考：</p>
<ul>
...
<p>详情：</p>
<p>该 Page 的摘要。</p>
<p>如果一个 Markdown 文件中包含一个 <code v-pre>&lt;!-- more --&gt;</code> 注释，那么该注释上方的内容都会被作为摘要提取并渲染。</p>
<p>如果你在创建一个用于博客的自定义主题，那么它可以帮助你创建一个包含摘要的文章列表。</p>
</li>
<li>
<p>示例：</p>
</li>
</ul>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>在 <span class="token code-snippet code keyword">`&lt;!-- more -->`</span> 注释上方的内容会被当作摘要。

建议你在该注释前后添加空行，以避免渲染问题。

<span class="token comment">&lt;!-- more --></span>

在 <span class="token code-snippet code keyword">`&lt;!-- more -->`</span> 注释下方的内容不会被当作摘要。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="headers" tabindex="-1"><a class="header-anchor" href="#headers" aria-hidden="true">#</a> headers</h3>
<ul>
<li>类型： <code v-pre>PageHeader[]</code></li>
</ul>
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">PageHeader</span> <span class="token punctuation">{</span>
...
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/reference/config.html#markdown-headers">配置 &gt; markdown.headers</RouterLink></li>
</ul>
</li>
</ul>
<h3 id="data" tabindex="-1"><a class="header-anchor" href="#data" aria-hidden="true">#</a> data</h3>
<ul>
<li>类型： <code v-pre>PageData</code></li>
</ul>
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">PageData</span> <span class="token punctuation">{</span>
...
<p>详情：</p>
<p>该 Page 的数据。</p>
<p>Page 数据可以在客户端代码中使用。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/reference/client-api.html#usepagedata">客户端 API &gt; usePageData</RouterLink></li>
<li><RouterLink to="/zh/reference/plugin-api.html#extendspage">插件 API &gt; extendsPage</RouterLink></li>
</ul>
</li>
</ul>
...
<li>
<p>详情：</p>
<p>该 Page 的未经渲染的原始内容。</p>
</li>
</ul>
<h3 id="contentrendered" tabindex="-1"><a class="header-anchor" href="#contentrendered" aria-hidden="true">#</a> contentRendered</h3>
<ul>
<li>
<p>类型： <code v-pre>string</code></p>
</li>
...
<h3 id="date" tabindex="-1"><a class="header-anchor" href="#date" aria-hidden="true">#</a> date</h3>
<ul>
<li>
<p>类型： <code v-pre>string</code></p>
</li>
<li>
<p>详情：</p>
<p>该 Page 的日期，遵从 'yyyy-MM-dd' 格式。</p>
</li>
<li>
<p>示例：</p>
<ul>
<li><code v-pre>'0000-00-00'</code></li>
<li><code v-pre>'2021-08-16</code>'</li>
</ul>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/reference/frontmatter.html#date">Frontmatter &gt; date</RouterLink></li>
</ul>
</li>
</ul>
<h3 id="deps" tabindex="-1"><a class="header-anchor" href="#deps" aria-hidden="true">#</a> deps</h3>
<ul>
<li>
<p>类型： <code v-pre>string[]</code></p>
</li>
...
<p>详情：</p>
<p>该 Page 的依赖。</p>
<p>举例来说，如果在页面中导入了代码片段，那么被导入文件的绝对路径就会被添加到 <code v-pre>deps</code> 中。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/reference/config.html#markdown-importcode">配置 &gt; markdown.importCode</RouterLink></li>
</ul>
</li>
</ul>
<h3 id="links" tabindex="-1"><a class="header-anchor" href="#links" aria-hidden="true">#</a> links</h3>
<ul>
<li>类型： <code v-pre>MarkdownLink[]</code></li>
</ul>
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">MarkdownLink</span> <span class="token punctuation">{</span>
...
<h3 id="pathinferred" tabindex="-1"><a class="header-anchor" href="#pathinferred" aria-hidden="true">#</a> pathInferred</h3>
<ul>
<li>
...
<li>
<p>详情：</p>
<p>该 Page 根据文件路径推断出的路由路径。</p>
<p>默认情况下，路由路径是根据 Markdown 源文件的相对文件路径推断出来的。然而，用户可能会显式指定页面路由，比如通过 <a href="#permalink">permalink</a> 来指定该页面最终使用的路由路径。因此我们在 Page 属性中保留推断出来的路径，以便于你在某些情况下可能会用到它。</p>
<p>如果该 Page 不是来自于 Markdown 源文件，那么该属性会为 <code v-pre>null</code> 。</p>
</li>
<li>
<p>示例：</p>
<ul>
<li><code v-pre>'/'</code></li>
<li><code v-pre>'/foo.html'</code></li>
</ul>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/guide/page.html#%E8%B7%AF%E7%94%B1">指南 &gt; 页面 &gt; 路由</RouterLink></li>
<li><a href="#path">Node API &gt; Page 属性 &gt; path</a></li>
</ul>
</li>
</ul>
<h3 id="pathlocale" tabindex="-1"><a class="header-anchor" href="#pathlocale" aria-hidden="true">#</a> pathLocale</h3>
<ul>
<li>
<p>类型： <code v-pre>string</code></p>
</li>
<li>
<p>详情：</p>
<p>该 Page 路由路径的 Locale 前缀。</p>
<p>它是根据页面的 Markdown 源文件相对路径、以及用户配置的 <code v-pre>locales</code> 的键推断得到的。</p>
</li>
<li>
<p>示例：</p>
<ul>
<li><code v-pre>'/'</code></li>
<li><code v-pre>'/en/'</code></li>
<li><code v-pre>'/zh/'</code></li>
</ul>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/reference/config.html#locales">配置 &gt; locales</RouterLink></li>
</ul>
</li>
</ul>
...
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/reference/frontmatter.html#permalink">Frontmatter &gt; permalink</RouterLink></li>
<li><RouterLink to="/zh/reference/frontmatter.html#permalinkpattern">Frontmatter &gt; permalinkPattern</RouterLink></li>
</ul>
</li>
</ul>
<h3 id="routemeta" tabindex="-1"><a class="header-anchor" href="#routemeta" aria-hidden="true">#</a> routeMeta</h3>
<ul>
<li>
<p>类型： <code v-pre>Record&lt;string, unknown&gt;</code></p>
</li>
<li>
<p>详情：</p>
<p>附加到 vue-router 路由记录上的额外数据。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/reference/frontmatter.html#routemeta">Frontmatter &gt; routeMeta</RouterLink></li>
<li><a href="https://router.vuejs.org/zh/api/#meta" target="_blank" rel="noopener noreferrer">vue-router &gt; API 参考 &gt; RouteRecordRaw &gt; meta<ExternalLinkIcon/></a></li>
</ul>
</li>
</ul>
<div class="custom-container tip"><p class="custom-container-title">Route Meta 和 Page Data 的区别是什么？</p>
<p><a href="#routemeta">Route Meta</a> 和 <a href="#data">Page Data</a> 都可以在客户端代码中使用。然而， Route Meta 是附加在路由记录上的，因此当用户进入你的站点时，所有页面的 Route Meta 都会立即被加载。相比之下， Page Data 是存储在单独的文件中的，只有在用户进入对应页面时才会被加载。</p>
<p>因此，不建议在 Route Meta 中存储大量的信息，否则在站点有很多页面时，将会影响站点的初始加载速度。</p>
</div>
<h3 id="sfcblocks" tabindex="-1"><a class="header-anchor" href="#sfcblocks" aria-hidden="true">#</a> sfcBlocks</h3>
<ul>
<li>
<p>类型： <code v-pre>string[]</code></p>
</li>
<li>
<p>详情：</p>
<p>该 Page 中提取出的 Vue SFC Blocks 。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/reference/config.html#markdown-sfc">配置 &gt; markdown.sfc</RouterLink></li>
</ul>
</li>
</ul>
<h3 id="slug" tabindex="-1"><a class="header-anchor" href="#slug" aria-hidden="true">#</a> slug</h3>
<ul>
<li>
<p>类型： <code v-pre>string</code></p>
</li>
...
<p>详情：</p>
<p>该 Page 的 Slug 。</p>
<p>它是根据页面的 Markdown 源文件的文件名推断得到的。</p>
</li>
</ul>
<h3 id="filepath" tabindex="-1"><a class="header-anchor" href="#filepath" aria-hidden="true">#</a> filePath</h3>
<ul>
<li>
<p>类型： <code v-pre>string | null</code></p>
</li>
<li>
<p>详情：</p>
<p>该 Page 的 Markdown 源文件的绝对路径。</p>
<p>如果该 Page 不是来自于 Markdown 源文件，那么该属性会为 <code v-pre>null</code> 。</p>
</li>
</ul>
<h3 id="filepathrelative" tabindex="-1"><a class="header-anchor" href="#filepathrelative" aria-hidden="true">#</a> filePathRelative</h3>
<ul>
<li>
<p>类型： <code v-pre>string | null</code></p>
</li>
<li>
<p>详情：</p>
<p>该 Page 的 Markdown 源文件的相对路径。</p>
<p>如果该 Page 不是来自于 Markdown 源文件，那么该属性会为 <code v-pre>null</code> 。</p>
</li>
</ul>
</div></template>
