<template><div><h1 id="theme-data" tabindex="-1"><a class="header-anchor" href="#theme-data" aria-hidden="true">#</a> theme-data</h1>
<NpmBadge package="@vuepress/plugin-theme-data" />
<p>为你的主题提供客户端数据，包含 VuePress 的 <RouterLink to="/zh/guide/i18n.html">多语言支持</RouterLink> 。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token punctuation">{</span> themeDataPlugin <span class="token punctuation">}</span> <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'@vuepress/plugin-theme-data'</span><span class="token punctuation">)</span>
...
<ul>
<li>
<p>类型： <code v-pre>ThemeData</code></p>
</li>
<li>
...
<p>主题数据对象在传递到客户端之前，会使用 <code v-pre>JSON.stringify()</code> 进行处理，因此你需要保证你提供的是一个可以被 JSON 序列化的对象。</p>
</div>
