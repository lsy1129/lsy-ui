<template><div><h1 id="docsearch" tabindex="-1"><a class="header-anchor" href="#docsearch" aria-hidden="true">#</a> docsearch</h1>
<NpmBadge package="@vuepress/plugin-docsearch" />
<p>将 <a href="https://docsearch.algolia.com/" target="_blank" rel="noopener noreferrer">Algolia DocSearch<ExternalLinkIcon/></a> 集成到 VuePress 中，为你的文档网站提供搜索功能。</p>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">npm</span> i -D @vuepress/plugin-docsearch@next
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token punctuation">{</span> docsearchPlugin <span class="token punctuation">}</span> <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'@vuepress/plugin-docsearch'</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="获取搜索索引" tabindex="-1"><a class="header-anchor" href="#获取搜索索引" aria-hidden="true">#</a> 获取搜索索引</h2>
<p>你需要 <a href="https://docsearch.algolia.com/apply/" target="_blank" rel="noopener noreferrer">提交你的网站 URL<ExternalLinkIcon/></a> 来加入 DocSearch 项目。当你的索引成功创建后， DocSearch 团队会将 <a href="#apikey">apiKey</a> 和 <a href="#indexname">indexName</a> 发送到你的邮箱。接下来，你就可以配置该插件，在 VuePress 中启用 DocSearch 了。</p>
<p>或者，你也可以 <a href="https://docsearch.algolia.com/docs/run-your-own/" target="_blank" rel="noopener noreferrer">运行你自己的爬虫<ExternalLinkIcon/></a> 来创建索引，然后使用你自己的 <a href="#appId">appId</a>, <a href="#apikey">apiKey</a> 和 <a href="#indexname">indexName</a> 来配置该插件。</p>
<details class="custom-container details"><summary>官方爬虫配置示例</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">new</span> <span class="token class-name">Crawler</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  ...
  <span class="token literal-property property">startUrls</span><span class="token operator">:</span> <span class="token punctuation">[</span>
    <span class="token comment">// 这是 Algolia 开始抓取网站的初始地址</span>
    <span class="token comment">// 如果你的网站被分为数个独立部分，你可能需要在此设置多个入口链接</span>
  ...
  <span class="token literal-property property">sitemaps</span><span class="token operator">:</span> <span class="token punctuation">[</span>
    <span class="token comment">// 如果你在使用 Sitemap 插件 (如: vuepress-plugin-sitemap2)，你可以提供 Sitemap 链接</span>
  ...
  <span class="token literal-property property">exclusionPatterns</span><span class="token operator">:</span> <span class="token punctuation">[</span>
    <span class="token comment">// 你可以通过它阻止 Algolia 抓取某些 URL</span>
  <span class="token punctuation">]</span><span class="token punctuation">,</span>
  <span class="token literal-property property">discoveryPatterns</span><span class="token operator">:</span> <span class="token punctuation">[</span>
    <span class="token comment">// 这是 Algolia 抓取 URL 的范围</span>
    <span class="token string">'https://YOUR_WEBSITE_URL/**'</span><span class="token punctuation">,</span>
  <span class="token punctuation">]</span><span class="token punctuation">,</span>
  <span class="token comment">// 爬虫执行的计划时间，可根据文档更新频率设置</span>
  ...
  <span class="token literal-property property">actions</span><span class="token operator">:</span> <span class="token punctuation">[</span>
    <span class="token comment">// 你可以拥有多个 action，特别是你在一个域名下部署多个文档时</span>
    <span class="token punctuation">{</span>
      <span class="token comment">// 使用适当的名称为索引命名</span>
      ...
      <span class="token comment">// 索引生效的路径</span>
      ...
      <span class="token comment">// 控制 Algolia 如何抓取你的站点</span>
      <span class="token function-variable function">recordExtractor</span><span class="token operator">:</span> <span class="token punctuation">(</span><span class="token parameter"><span class="token punctuation">{</span> $<span class="token punctuation">,</span> helpers <span class="token punctuation">}</span></span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
        <span class="token comment">// @vuepress/theme-default 的选项</span>
  ...
  <span class="token literal-property property">initialIndexSettings</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token comment">// 控制索引如何被初始化，这仅当索引尚未生成时有效</span>
    <span class="token comment">// 你可能需要在修改后手动删除并重新生成新的索引</span>
...
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>如果你使用的不是默认主题，或者在使用 Docsearch 的时候遇到了任何问题，你也可以检查上述的爬虫配置示例，然后前往 <a href="https://crawler.algolia.com/admin/crawlers/" target="_blank" rel="noopener noreferrer">Algolia Crawler<ExternalLinkIcon/></a> 仓库，在你项目侧边栏中的 Editor 页面中修改你的配置。</p>
</div>
<h2 id="配置项" tabindex="-1"><a class="header-anchor" href="#配置项" aria-hidden="true">#</a> 配置项</h2>
<h3 id="apikey" tabindex="-1"><a class="header-anchor" href="#apikey" aria-hidden="true">#</a> apiKey</h3>
<ul>
<li>
...
<p>参考：</p>
<ul>
<li><a href="https://docsearch.algolia.com/docs/api#apikey" target="_blank" rel="noopener noreferrer">DocSearch &gt; Options &gt; apiKey<ExternalLinkIcon/></a></li>
</ul>
</li>
</ul>
<h3 id="indexname" tabindex="-1"><a class="header-anchor" href="#indexname" aria-hidden="true">#</a> indexName</h3>
<ul>
<li>
<p>类型： <code v-pre>string</code></p>
</li>
...
<p>参考：</p>
<ul>
<li><a href="https://docsearch.algolia.com/docs/api#indexname" target="_blank" rel="noopener noreferrer">DocSearch &gt; Options &gt; indexName<ExternalLinkIcon/></a></li>
</ul>
</li>
</ul>
<h3 id="appid" tabindex="-1"><a class="header-anchor" href="#appid" aria-hidden="true">#</a> appId</h3>
<ul>
<li>
<p>类型： <code v-pre>string</code></p>
</li>
...
<p>参考：</p>
<ul>
<li><a href="https://docsearch.algolia.com/docs/api#appid" target="_blank" rel="noopener noreferrer">DocSearch &gt; Options &gt; appId<ExternalLinkIcon/></a></li>
</ul>
</li>
</ul>
<h3 id="searchparameters" tabindex="-1"><a class="header-anchor" href="#searchparameters" aria-hidden="true">#</a> searchParameters</h3>
<ul>
<li>
...
<p>参考：</p>
<ul>
<li><a href="https://docsearch.algolia.com/docs/api/#searchparameters" target="_blank" rel="noopener noreferrer">DocSearch &gt; Options &gt; searchParameters<ExternalLinkIcon/></a></li>
<li><a href="https://www.algolia.com/doc/api-reference/search-api-parameters/" target="_blank" rel="noopener noreferrer">Algolia &gt; Search API Parameters<ExternalLinkIcon/></a></li>
</ul>
</li>
</ul>
<h3 id="placeholder" tabindex="-1"><a class="header-anchor" href="#placeholder" aria-hidden="true">#</a> placeholder</h3>
<ul>
<li>
<p>类型： <code v-pre>string</code></p>
</li>
...
<p>参考：</p>
<ul>
<li><a href="https://docsearch.algolia.com/docs/api#placeholder" target="_blank" rel="noopener noreferrer">DocSearch &gt; Options &gt; placeholder<ExternalLinkIcon/></a></li>
</ul>
</li>
</ul>
<h3 id="disableuserpersonalization" tabindex="-1"><a class="header-anchor" href="#disableuserpersonalization" aria-hidden="true">#</a> disableUserPersonalization</h3>
<ul>
<li>
...
<p>参考：</p>
<ul>
<li><a href="https://docsearch.algolia.com/docs/api#disableuserpersonalization" target="_blank" rel="noopener noreferrer">DocSearch &gt; Options &gt; disableUserPersonalization<ExternalLinkIcon/></a></li>
</ul>
</li>
</ul>
<h3 id="initialquery" tabindex="-1"><a class="header-anchor" href="#initialquery" aria-hidden="true">#</a> initialQuery</h3>
<ul>
<li>
<p>类型： <code v-pre>string</code></p>
</li>
...
<p>参考：</p>
<ul>
<li><a href="https://docsearch.algolia.com/docs/api#initialquery" target="_blank" rel="noopener noreferrer">DocSearch &gt; Options &gt; initialQuery<ExternalLinkIcon/></a></li>
</ul>
</li>
</ul>
<h3 id="translations" tabindex="-1"><a class="header-anchor" href="#translations" aria-hidden="true">#</a> translations</h3>
<ul>
<li>
...
<p>参考：</p>
<ul>
<li><a href="https://docsearch.algolia.com/docs/api/#translations" target="_blank" rel="noopener noreferrer">DocSearch &gt; Options &gt; translations<ExternalLinkIcon/></a></li>
</ul>
</li>
</ul>
...
<p>你可以通过 <a href="https://docsearch.algolia.com/docs/styling" target="_blank" rel="noopener noreferrer">@docsearch/css<ExternalLinkIcon/></a> 提供的 CSS 变量来自定义样式：</p>
...
<h3 id="docsearch-1" tabindex="-1"><a class="header-anchor" href="#docsearch-1" aria-hidden="true">#</a> Docsearch</h3>
<ul>
<li>
<p>详情：</p>
