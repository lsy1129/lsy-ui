...
<h2 id="站点配置" tabindex="-1"><a class="header-anchor" href="#站点配置" aria-hidden="true">#</a> 站点配置</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>渲染为：</p>
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code><span class="token keyword">const</span> defaultOptions <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code><span class="token keyword">const</span> defaultOptions <span class="token operator">=</span> <span class="token punctuation">{</span>
  grayMatterOptions<span class="token operator">:</span> <span class="token punctuation">{</span>
    excerpt<span class="token operator">:</span> <span class="token boolean">true</span><span class="token punctuation">,</span>
    excerpt_separator<span class="token operator">:</span> <span class="token string">'&lt;!-- more -->'</span><span class="token punctuation">,</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>
<p>详情：</p>
<p><a href="https://github.com/mdit-vue/mdit-vue/tree/main/packages/plugin-frontmatter" target="_blank" rel="noopener noreferrer">@mdit-vue/plugin-frontmatter<ExternalLinkIcon/></a> 插件的配置项。</p>
<p>设置为 <code v-pre>false</code> 可以禁用该插件。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/guide/page.html#frontmatter">指南 &gt; 页面 &gt; Frontmatter</RouterLink></li>
<li><RouterLink to="/zh/reference/node-api.html#frontmatter">Node API &gt; Page 属性 &gt; frontmatter</RouterLink></li>
<li><RouterLink to="/zh/reference/node-api.html#excerpt">Node API &gt; Page 属性 &gt; excerpt</RouterLink></li>
</ul>
</li>
</ul>
<div class="custom-container danger"><p class="custom-container-title">DANGER</p>
...
<h3 id="markdown-headers" tabindex="-1"><a class="header-anchor" href="#markdown-headers" aria-hidden="true">#</a> markdown.headers</h3>
<ul>
<li>
<p>类型： <code v-pre>HeadersPluginOptions | false</code></p>
</li>
<li>
<p>默认值：</p>
</li>
...
<li>
<p>详情：</p>
<p><a href="https://github.com/mdit-vue/mdit-vue/tree/main/packages/plugin-headers" target="_blank" rel="noopener noreferrer">@mdit-vue/plugin-headers<ExternalLinkIcon/></a> 插件的配置项。</p>
<p>设置为 <code v-pre>false</code> 可以禁用该插件。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/reference/node-api.html#headers">Node API &gt; Page 属性 &gt; headers</RouterLink></li>
</ul>
</li>
</ul>
<h3 id="markdown-title" tabindex="-1"><a class="header-anchor" href="#markdown-title" aria-hidden="true">#</a> markdown.title</h3>
<ul>
<li>
<p>类型： <code v-pre>undefined | false</code></p>
</li>
<li>
<p>详情：</p>
<p><a href="https://github.com/mdit-vue/mdit-vue/tree/main/packages/plugin-title" target="_blank" rel="noopener noreferrer">@mdit-vue/plugin-title<ExternalLinkIcon/></a> 插件的配置项。</p>
<p>设置为 <code v-pre>false</code> 可以禁用该插件。</p>
</li>
</ul>
<div class="custom-container danger"><p class="custom-container-title">DANGER</p>
...
<h3 id="markdown-importcode" tabindex="-1"><a class="header-anchor" href="#markdown-importcode" aria-hidden="true">#</a> markdown.importCode</h3>
<ul>
<li>
<p>类型： <code v-pre>ImportCodePluginOptions | false</code></p>
</li>
<li>
<p>详情：</p>
<p>VuePress 内置的 markdown-it 导入代码插件的配置项。</p>
<p>设置为 <code v-pre>false</code> 可以禁用该插件。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/guide/markdown.html#%E5%AF%BC%E5%85%A5%E4%BB%A3%E7%A0%81%E5%9D%97">指南 &gt; Markdown &gt; 语法扩展 &gt; 导入代码块</RouterLink></li>
</ul>
</li>
</ul>
<h4 id="markdown-importcode-handleimportpath" tabindex="-1"><a class="header-anchor" href="#markdown-importcode-handleimportpath" aria-hidden="true">#</a> markdown.importCode.handleImportPath</h4>
<ul>
<li>
<p>类型： <code v-pre>(str: string) =&gt; string</code></p>
</li>
<li>
<p>默认值： <code v-pre>(str) =&gt; str</code></p>
</li>
<li>
<p>详情：</p>
<p>一个函数，用于处理导入代码语法中的文件导入路径。</p>
</li>
</ul>
<h3 id="markdown-links" tabindex="-1"><a class="header-anchor" href="#markdown-links" aria-hidden="true">#</a> markdown.links</h3>
<ul>
<li>
<p>类型： <code v-pre>LinkPluginOptions | false</code></p>
</li>
<li>
<p>详情：</p>
<p>VuePress 内置的 markdown-it 链接插件的配置项。</p>
<p>它可以把站内链接转换为 <code v-pre>&lt;RouterLink&gt;</code> ，并且可以在站外链接上添加额外的属性和图标。</p>
<p>设置为 <code v-pre>false</code> 可以禁用该插件。</p>
</li>
<li>
<p>参考：</p>
...
<h4 id="markdown-links-internaltag" tabindex="-1"><a class="header-anchor" href="#markdown-links-internaltag" aria-hidden="true">#</a> markdown.links.internalTag</h4>
<ul>
<li>
<p>类型： <code v-pre>string</code></p>
</li>
<li>
<p>默认值： <code v-pre>'RouterLink'</code></p>
</li>
<li>
<p>详情：</p>
<p>内部链接所使用的标签。</p>
<p>默认情况下，该插件会把内部链接转换为 <code v-pre>&lt;RouterLink&gt;</code> 。你可以把该选项设置为 <code v-pre>'a'</code> 来禁用这个功能。</p>
</li>
</ul>
<h4 id="markdown-links-externalattrs" tabindex="-1"><a class="header-anchor" href="#markdown-links-externalattrs" aria-hidden="true">#</a> markdown.links.externalAttrs</h4>
<ul>
<li>
<p>类型： <code v-pre>Record&lt;string, string&gt;</code></p>
</li>
<li>
<p>默认值： <code v-pre>{ target: '_blank', rel: 'noopener noreferrer' }</code></p>
</li>
<li>
<p>详情：</p>
<p>为外部链接添加额外的属性。</p>
...
<h3 id="markdown-sfc" tabindex="-1"><a class="header-anchor" href="#markdown-sfc" aria-hidden="true">#</a> markdown.sfc</h3>
<ul>
<li>
<p>类型： <code v-pre>SfcPluginOptions | false</code></p>
</li>
<li>
<p>详情：</p>
<p><a href="https://github.com/mdit-vue/mdit-vue/tree/main/packages/plugin-sfc" target="_blank" rel="noopener noreferrer">@mdit-vue/plugin-sfc<ExternalLinkIcon/></a> 插件的配置项。</p>
<p>设置为 <code v-pre>false</code> 可以禁用该插件。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/zh/advanced/cookbook/markdown-and-vue-sfc.html">Cookbook &gt; Markdown 与 Vue SFC</RouterLink></li>
<li><RouterLink to="/zh/reference/node-api.html#sfcblocks">Node API &gt; Page 属性 &gt; sfcBlocks</RouterLink></li>
</ul>
</li>
</ul>
<h3 id="markdown-slugify" tabindex="-1"><a class="header-anchor" href="#markdown-slugify" aria-hidden="true">#</a> markdown.slugify</h3>
<ul>
<li>
<p>类型： <code v-pre>(str: string) =&gt; string</code></p>
</li>
<li>
<p>详情：</p>
<p>默认使用的 slugify 函数。</p>
</li>
</ul>
<h3 id="markdown-toc" tabindex="-1"><a class="header-anchor" href="#markdown-toc" aria-hidden="true">#</a> markdown.toc</h3>
<ul>
<li>
<p>类型： <code v-pre>TocPluginOptions | false</code></p>
</li>
<li>
<p>默认值：</p>
</li>
...
<li>
<p>详情：</p>
<p><a href="https://github.com/mdit-vue/mdit-vue/tree/main/packages/plugin-toc" target="_blank" rel="noopener noreferrer">@mdit-vue/plugin-toc<ExternalLinkIcon/></a> 插件的配置项。</p>
<p>设置为 <code v-pre>false</code> 可以禁用该插件。</p>
</li>
<li>
<p>参考：</p>
...
<ul>
<li>
<p>类型： <code v-pre>PluginConfig[]</code></p>
</li>
<li>
<p>详情：</p>
<p>要使用的插件。</p>
<p>该配置项接收一个数组，其中的每一个数组项是一个或一组插件。</p>
</li>
<li>
<p>参考：</p>
<ul>
...
<h2 id="插件-api" tabindex="-1"><a class="header-anchor" href="#插件-api" aria-hidden="true">#</a> 插件 API</h2>
<p>用户配置文件同样可以作为一个 VuePress 插件，所以除了 <code v-pre>name</code> 和 <code v-pre>multiple</code> 配置项以外的所有插件 API 都可以在配置文件中使用。</p>
