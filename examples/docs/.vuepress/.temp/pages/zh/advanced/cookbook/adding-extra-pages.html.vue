<template><div><h1 id="添加额外页面" tabindex="-1"><a class="header-anchor" href="#添加额外页面" aria-hidden="true">#</a> 添加额外页面</h1>
<p>有时你可能希望在不创建 Markdown 文件的情况下添加一些额外的页面。</p>
<p>我们可以借助于 <RouterLink to="/zh/reference/plugin-api.html">插件 API</RouterLink> 和 <RouterLink to="/zh/reference/node-api.html">Node API</RouterLink> 来轻松实现。</p>
<h2 id="添加默认的主页" tabindex="-1"><a class="header-anchor" href="#添加默认的主页" aria-hidden="true">#</a> 添加默认的主页</h2>
<p>作为一个主题作者，你可能不想要求用户必须创建一个 <code v-pre>/README.md</code> 文件来作为主页，但是你希望提供一个默认的主页：</p>
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> createPage <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'@vuepress/core'</span>
