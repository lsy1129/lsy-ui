<template><div><h1 id="markdown-与-vue-sfc" tabindex="-1"><a class="header-anchor" href="#markdown-与-vue-sfc" aria-hidden="true">#</a> Markdown 与 Vue SFC</h1>
<p>每一个 Markdown 文件，首先都会编译为 HTML ，然后转换为一个 Vue 单文件组件 (SFC) 。换句话说，你可以像写 Vue SFC 一样来写 Markdown 文件：</p>
<ul>
<li><code v-pre>&lt;script&gt;</code> 和 <code v-pre>&lt;style&gt;</code> 标签会直接被当作 Vue SFC 中的标签。换句话说，它们是从 <code v-pre>&lt;template&gt;</code> 标签中提升到了 SFC 的顶层。</li>
<li>所有 <code v-pre>&lt;script&gt;</code> 和 <code v-pre>&lt;style&gt;</code> 标签的以外的内容，会先被编译为 HTML ，然后被当作 Vue SFC 的 <code v-pre>&lt;template&gt;</code> 标签。</li>
</ul>
<div class="custom-container warning"><p class="custom-container-title">注意</p>
<p>由于 Vue 单文件组件只能包含一个 <code v-pre>&lt;script&gt;</code> 标签，你应该避免在 VuePress Markdown 中使用多于一个 <code v-pre>&lt;script&gt;</code> 标签。</p>
</div>
<p>我们来看一个例子：</p>
<p><strong>输入</strong></p>
<div class="language-vue ext-vue line-numbers-mode"><pre v-pre class="language-vue"><code>_你好， {{ msg }}_
