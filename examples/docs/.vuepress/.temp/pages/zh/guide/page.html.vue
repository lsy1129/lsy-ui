<template><div><h1 id="页面" tabindex="-1"><a class="header-anchor" href="#页面" aria-hidden="true">#</a> 页面</h1>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>└─ docs
   ...
   ├─ contributing.md
   └─ README.md
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>将 <code v-pre>docs</code> 目录作为你的 <RouterLink to="/zh/reference/cli.html">sourceDir</RouterLink> ，例如你在运行 <code v-pre>vuepress dev docs</code> 命令。此时，你的 Markdown 文件对应的路由路径为：</p>
<table>
<thead>
<tr>
<th>相对路径</th>
...
<tr>
<td><code v-pre>/guide/page.md</code></td>
<td><code v-pre>/guide/page.html</code></td>
</tr>
</tbody>
</table>
...
<p>在这种情况下，你可以设置 <RouterLink to="/zh/reference/config.html#pagepatterns">pagePatterns</RouterLink> 来避免某个文件被 VuePress 处理，例如使用 <code v-pre>['**/*.md', '!**/README.md', '!.vuepress', '!node_modules']</code> 来排除所有的 <code v-pre>README.md</code> 文件。</p>
</div>
<h2 id="frontmatter" tabindex="-1"><a class="header-anchor" href="#frontmatter" aria-hidden="true">#</a> Frontmatter</h2>
<p>Markdown 文件可以包含一个 <a href="https://yaml.org/" target="_blank" rel="noopener noreferrer">YAML<ExternalLinkIcon/></a> Frontmatter 。Frontmatter 必须在 Markdown 文件的顶部，并且被包裹在一对三短划线中间。下面是一个基本的示例：</p>
...
<p>借助 <a href="https://github.com/markdown-it/markdown-it" target="_blank" rel="noopener noreferrer">markdown-it<ExternalLinkIcon/></a> 和 Vue 模板语法的能力，基础的 Markdown 可以得到很多的扩展功能。接下来，前往 <RouterLink to="/zh/guide/markdown.html">Markdown</RouterLink> 章节来了解 VuePress 中 Markdown 的扩展功能。</p>
</div></template>
